      ...
      <div className="bg-white border rounded-xl overflow-hidden shadow-sm">
        <div className="divide-y md:hidden">
          {sortedTickets.map((ticket) => (
            <div key={ticket.id} className="space-y-4 p-4">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="font-mono text-xs text-slate-500 break-all">{ticket.tracking_id}</p>
                  <p className="mt-1 font-semibold text-slate-900 break-words">{ticket.title}</p>
                </div>
                <span className="shrink-0 rounded-full bg-amber-100 px-2 py-1 text-xs font-bold uppercase text-amber-800">
                  {ticket.status}
                </span>
              </div>
              <div className="rounded-lg bg-slate-50 p-3 text-sm text-slate-600">
                <p className="font-medium text-slate-700">Deadline</p>
        ...
        {selectedTicket && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl p-4 sm:p-6 max-w-2xl w-full shadow-2xl max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-start gap-3 mb-4">
                <h3 className="text-lg font-bold break-all sm:text-xl">Manage Ticket: {selectedTicket.tracking_id}</h3>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-2 max-h-40 overflow-y-auto p-3 border rounded-lg bg-slate-50 sm:grid-cols-2">
